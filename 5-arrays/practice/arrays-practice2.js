...
const food2 = ["Apples" , 7 , {} , "Coconuts" , "Guava"] ;
// Make a list of classmates names first names in an array
const classmates= ["Aliesha" , "Armani" , "Chanel" , "Daja" , "Juan" , "Odalis"] ;
...
// Update the array to have each element as a students first and last name : 'firstName lastName'
 // let classmates = "firstName" , "lastName"

 classmates.forEach("lastNames")

 // console.log(classmates["firstName" , "lastName"])
